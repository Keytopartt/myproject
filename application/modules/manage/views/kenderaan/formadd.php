  ...
  <div class="card">
	...
	<div class="card-body">
	  ...
	  <div class="mb-4 row align-items-center"> 
		...
		<div class="col-sm-9">
		  <input type="text" class="form-control" id="exampleInputText6" placeholder="dd/mm/yyyy" name="kod_kend">
		</div>
	  </div>
	  <div class="mb-4 row align-items-center"> 
		<label for="exampleInputText5" class="form-label fw-semibold col-sm-3 col-form-label text-end">NAMA KENDERAAN</label>
		<div class="col-sm-9">
		  <input type="text" class="form-control" id="exampleInputText6" placeholder="dd/mm/yyyy" name="nama"> 
		</div>
	  </div>
	  <div class="mb-4 row align-items-center">
		...
		<div class="col-sm-9">
		  <div class="input-group">
			<input type="text" class="form-control" id="exampleInputText6" placeholder="123 4567 201" name=no_plat>
		  </div>
		</div>
	  </div>
	  <div class="mb-4 row align-items-center">
		...
		<div class="col-sm-9">
		  <div class="input-group">
			<input type="text" class="form-control" id="exampleInputText6" placeholder="Tujuan" name=jenama>
		  </div>
		</div>
	  </div>
	  <div class="mb-4 row align-items-center">
		...
		<div class="col-sm-9">
		  <div class="input-group">
			<select class="form-select" id="exampleInputselect" aria-label="Default select example" name=varian>
